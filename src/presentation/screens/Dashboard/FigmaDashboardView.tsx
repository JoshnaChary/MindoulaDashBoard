...
const FigmaDashboardView: React.FC = () => {
  ...
  return (
    <MemberPortalLayout>
      ...
      <Text style={[styles.absolute, styles.dateMonth, { left: 381 - BASE_X, top: 434 - BASE_Y }]}>
        April
      </Text>
      <Text style={[styles.absolute, styles.apptTitle, { left: 470 - BASE_X, top: 405 - BASE_Y }]}>
...
const styles = StyleSheet.create({
  ...
  buttonText: { color: Colors.white, fontSize: 16, fontWeight: '500', fontFamily: 'Inter' },
  actionCard: {
    width: 653,
    height: 104,
    backgroundColor: Colors.white,
